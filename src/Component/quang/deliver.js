          ...
          <Row style={{ width: "100%" }}>
            ...
            <Col md={10}>
              <div class="manage_search">
                <Nav variant="pills" defaultActiveKey="/adm_deliver">
                  <Nav.Item>
                    <Nav.Link href="/adm_ord" eventKey="confirm">Xác nhận</Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link href="/adm_deliver">Giao hàng</Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                ...
                <Row style={{backgroundColor: "lightgrey", marginBottom: "16px"}}>
                  <Col md={6}>
                    <div>
                      ...
                      <span style={{fontWeight: "bold"}}>Ngày xác nhận đơn hàng:</span> 20/05/2023
                    </div>
                  </Col>
                  ...
                  <Col style={{ position: "relative" }}>
                    ...
                    <p style={{fontWeight: "bold", fontSize: "20px"}}>Tổng tiền: 62.000.000đ</p>
                      ...
                      <Button variant="success" href="/adm_delivered">Xác nhận</Button>
