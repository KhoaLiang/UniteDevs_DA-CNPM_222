    ...
    <Row style={{width:'100%'}}>
        ...
        <Col md={10}>
          <div class="manage_search">
            ...
            <div class="search">
              ...
              <button class="btn btn-primary" onClick={handleShowFormAdd}>
                Thêm thành viên
              </button>
            </div>
          </div>
      ...
      <tbody>
          ...
          <tr>
            ...
            <td>0399609015</td>
            <td>
                <button type="button" class="btn btn-success dieu_chinh">Đơn hàng</button>
                <button type="button" class="btn btn-info dieu_chinh" onClick={handleShowFormInfo}>Thông tin</button>
                <button type="button" class="btn btn-danger dieu_chinh" onClick={handleShowDelete}>Xóa KH</button>
            </td>
          </tr>
          <tr>
            <td>lequoctrang4</td>
          ...
          {showFormInfo && <InfoUser />}
          {showFormAdd && <AddUserForm />}
      </tbody>
    </Table>
        </Col>
      </Row>
